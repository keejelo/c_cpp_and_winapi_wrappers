...
LRESULT CALLBACK DialogProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    switch(msg)
    {
        case WM_CREATE:
            /*
            HWND hEdit = CreateEditCtrl(hWnd, ID_EDIT1, "", 10, 10, 100); // <---- using "Controls.h"
            CreateButtonCtrl(hWnd, ID_BUTTON1, "OK", 10, 50);             // <---- using "Controls.h"
            CreateButtonCtrl(hWnd, ID_BUTTON2, "Cancel", 130, 50);        // <---- using "Controls.h"
